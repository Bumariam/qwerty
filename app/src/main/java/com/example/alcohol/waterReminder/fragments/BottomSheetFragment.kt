package com.example.alcohol.fragments
...
import com.example.alcohol.MainWaterActivity
import com.example.alcohol.R
import com.example.alcohol.helpers.AlarmHelper
import com.example.alcohol.helpers.SqliteHelper
        ...
        btnUpdate.setOnClickListener {
            ...
            when {
                ...
                TextUtils.isEmpty(customTarget) -> Toast.makeText(
                    ...
                    dismiss()
                    (activity as MainWaterActivity?)!!.updateValues()
